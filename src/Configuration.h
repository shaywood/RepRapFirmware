...
const unsigned int DhtTemperatureChannel = 400;		// Temperature sensor channel 400 for DHTxx temperature
const unsigned int DhtHumidityChannel = 401;		// Temperature sensor channel 401 for DHTxx humidity
