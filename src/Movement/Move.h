...
public:
    ...
    FilePosition PausePrint(float positions[DRIVES], float& pausedFeedRate, unsigned int &skippedMoves);	// Pause the print as soon as we can and return the number of skipped moves
